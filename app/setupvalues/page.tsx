...
const SetupValuesPage = () => {
  return (
    <div className="my-8 flex flex-col items-center">
      <h1 className="text-center text-4xl mb-6">تفاصيل مستويات الحماية</h1>
      <h2 className="text-center text-3xl  px-4 py-px mb-4 font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-400">
        الجيل الأول
      </h2>
