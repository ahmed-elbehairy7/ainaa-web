...
{
type: "text",
data: "دلوقتي بعد ما فعلت الحماية الموقع ده هيقفل!! و لو حابب تعمل الخطوات على جهاز تاني هتحتاج تتواصل معانا على الماسنجر ان شاء الله"
},
 {
    type: "link",
    data: {
...
{
type: "text",
data : "السبب في كده اننا مش عايزين حد في لحظة ضعف يخش يشوف الخطوات و يفكها، بحيث ان الخدمة تكون فعالة مع الشباب المبتلى"
},
];