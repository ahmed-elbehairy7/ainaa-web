		...
		<section className="px-6 py-6 max-w-screen-md mx-auto text-center">
			...
			<div className="mt-8 p-6 bg-white shadow-lg rounded-xl border border-gray-200">
				...
				<ul className="mt-4 text-lg text-gray-700 leading-relaxed space-y-3">
					...
					<li>
						🔹 للوقاية من الإدمان المدمر الذي يضيع الأوقات ويفسد
						العقول.
					</li>
			...
			<div className="mt-8 p-6 bg-white shadow-lg rounded-xl border border-gray-200">
				...
				<p className="mt-4 text-lg text-gray-700 leading-relaxed">
					نحن نوفر إعدادات بسيطة يمكنك تطبيقها في جهاز الراوتر الخاص
					بك لمنع المواقع الإباحية نهائيًا. هذه الإعدادات تمنع أي جهاز
					متصل بشبكتك من الوصول إلى المحتوى الفاسد، مما يوفر حماية
					شاملة لكل أفراد الأسرة.
				</p>
			</div>
			...
			<div className="mt-8 p-6 bg-white shadow-lg rounded-xl border border-gray-200">
				...
				<p className="mt-4 text-lg text-gray-700 leading-relaxed">
					تابع آخر التحديثات والأخبار حول المشروع عبر جروب واتساب
					الخاص بنا.
				</p>
				<div className="mt-4 flex justify-center gap-4">
					<a
